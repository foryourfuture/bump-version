...
```bash
npm install -D  @sealgo/bump-version conventional-changelog commitizen cz-customizable @commitlint/cli husky

#or

yarn add -D  @sealgo/bump-version conventional-changelog commitizen cz-customizable @commitlint/cli husky
```
...
"config": {
  ...
  "cz-customizable": {
    "config": "./node_modules/@sealgo/bump-version/.cz-config.js"
  }
},
"commitlint": {
  "extends": ["./node_modules/@sealgo/bump-version/commitlint-sealgo"]
}
```
...
Let more people know that you are using sealgo bump-version for elegant workflow!

```md
[![sealgo Convention](https://img.shields.io/badge/sealgo-convention-blue.svg?style=flat-square)](https://github.com/sealgo/bump-version)
```

## SealGo Convention

sealgo's commit message guidelines.
